var MachineItemController = function () {
    ...
    function loadData(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/MachineItem/GetAllPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
    ...
    function saveToken(e) {
        ...
        var model = new MachineItemViewModel();
        if (model.Validate()) {
            $.ajax({
                type: "POST",
                url: "/Admin/MachineItem/SaveEntity",
                data: { model },
                dataType: "json",
                beforeSend: function () {
                    be.startLoading();
                ...
                success: function (response) {
                    ...
                    be.notify('Update machine item is success', 'success');

var ShopItemController = function () {
    ...
    function loadData(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/ShopItem/GetAllPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
        ...
        if (model.Validate()) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    be.notify('Update shop item is success', 'success');
